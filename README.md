...
2. **🎯 专业文档工具** (`professional_document_tool`) - 完整的RAG+AI智能文档处理功能
3. **📋 模板分类工具** (`template_classifier`) - 智能判断文档类型并分类处理
4. **🚀 高级长文档生成工具** (`advanced_long_document_generator`) - 专业长篇文档智能生成器
...
| 🚀 高级长文档生成器 | 长篇专业文档生成 | 技术报告、研究文档 | **多阶段生成、任务管理、向量搜索集成** |
