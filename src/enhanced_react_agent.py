...
📋 **模板文档 (表格格式、空白字段、需要填写)** → 使用 `professional_document_tool`
- ✅ 各种记录表：复核记录、检查记录、验收记录、巡检记录
- ✅ 申请表单：施工申请、变更申请、材料申请  
- ✅ 审批表格：审批单、签证单、工程联系单
- ✅ 检测表格：试验记录、测量记录、质检记录
- 🔍 **判断关键词**: 记录、表格、申请、审批、检查、验收、登记、填写
- 📄 **特征**: 包含空白字段(____、＿＿)、占位符(【】、（）)、表单结构

📄 **长篇文档 (连续文本、多章节、超过500字)** → 使用 `long_document_generator`  
- ✅ 技术方案：施工方案、设计方案、技术方案
- ✅ 报告文档：技术报告、可行性报告、评估报告
- ✅ 计划文档：项目计划、实施计划、工作计划
- ✅ 规范文档：操作规程、管理制度、技术规范
- 🔍 **判断关键词**: 方案、报告、计划、规程、制度、分析、研究
- 📄 **特征**: 多章节结构、连续文本、需要详细阐述

📚 **资料文档 (已有内容、需要检索分析)** → 使用 `rag_tool`
- ✅ 会议纪要、项目资料、技术文档、规范标准
- ✅ 知识库构建、文档搜索、内容检索
- 🔍 **判断关键词**: 搜索、查找、检索、分析、提取
- 📄 **特征**: 已有具体内容、需要embedding处理、语义搜索
...
3. **三工具选择流程** - 这是最重要的！按以下顺序判断：
   
   **第一步：文档类型判断**
   - 📋 **模板文档** (空白字段、表格格式) → `professional_document_tool`
   - 📄 **长篇文档** (连续文本、多章节) → `long_document_generator`  
   - 📚 **资料文档** (已有内容、需要检索) → `rag_tool`
   
   **第二步：关键词识别**
   - 模板关键词：记录、表格、申请、审批、检查、验收、登记、填写
   - 长文档关键词：方案、报告、计划、规程、制度、分析、研究
   - 资料关键词：搜索、查找、检索、分析、提取
   
   **第三步：文档特征确认**
   - 模板特征：空白字段(____、＿＿)、占位符(【】、（）)、表单结构
   - 长文档特征：多章节结构、连续文本、需要详细阐述
   - 资料特征：已有具体内容、需要embedding处理、语义搜索
